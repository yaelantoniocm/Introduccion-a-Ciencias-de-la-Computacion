...
public class Mosca {
	 ...
	 */
	public String canta() {
		String sing = original.replace('a', this.vocal);
		sing = sing.replace('e',this.vocal); 
		sing = sing.replace('i',this.vocal);
		sing = sing.replace('o',this.vocal);
		sing = sing.replace('u',this.vocal);
		return sing;
	}
